				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form login-signin-on">
							...
							<form class="form" method="POST" action="{{ route('login.post') }}" novalidate="novalidate" >
                                @csrf
								<!--begin::Title-->
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Selamat Datang Di Aplikasi Mutasi Siswa</h3>
									<span class="text-muted font-weight-bold font-size-h4">Sudah Memiliki Akun?
									<a href="register"  class="text-primary font-weight-bolder">Buat Akun</a></span>
								</div>
