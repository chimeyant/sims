...
<html lang="en">
	...
	<head><base href="../../../">
		...
		<link href="assets/css/pages/login/login-1.css?v=7.0.4" rel="stylesheet" type="text/css" />
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<!--end::Aside header-->
						<!--begin::Aside title-->
						<h3 class="font-weight-bolder text-center font-size-h6 font-size-h3-lg" style="color: #986923;">SIMS
						<br />Sistem Informasi Manajemen Mutasi Siswa</h3>
						<!--end::Aside title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<div class="d-flex flex-column-fluid flex-center">
						...
						<div class="login-form login-signup-on">
							<!--begin::Form-->
							<form class="form" method="post" action="/register" novalidate="novalidate" id="kt_login_signup_form">
								<!--begin::Title-->
                                @csrf
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Registrasi Akun</h3>
									<p class="text-muted font-weight-bold font-size-h4">Silahkan masukan data akun anda</p>
								</div>
								<!--end::Title-->
								<!--begin::Form group-->
								<div class="form-group">
									<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="Nama Lengkap" name="name" autocomplete="off" />
								</div>
								<!--end::Form group-->
								<!--begin::Form group-->
								<div class="form-group">
								...
								<div class="form-group d-flex flex-wrap pb-lg-0 pb-3">
									<button type="submit" id="kt_login_signup_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Kirim</button>
